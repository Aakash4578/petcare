        ...
        >
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-3">
              ...
              />
              {error.subject && (
                <div className="text-danger mt-1">{error.subject}</div>
              )}
            </div>
            ...
            <div className="mb-3">
              ...
              ></textarea>
              {error.faqQuestion && (
                <div className="text-danger mt-1">{error.faqQuestion}</div>
              )}
            </div>
            ...
            <div className="mb-3">
              ...
              ></textarea>
              {error.faqAnswer && (
                <div className="text-danger mt-1">{error.faqAnswer}</div>
              )}
            </div>
